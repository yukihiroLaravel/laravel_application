<header class="mb-5">
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="nav-bar">
            ...
            <ul class="navbar-nav">
                @if (Auth::check())
                <li class="nav-item"><a href="{{ route('movie.create') }}" class="nav-link">
                ...
                <li class="nav-item"><a href="{{ route('user.show', Auth::id()) }}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="nav-item"><a href="{{ route('signup') }}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
<p class="text-right mr-3 pb-3">
    ユーザー：<span class="user-name"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            class="bi bi-person-video3" viewBox="0 0 16 16">
            <path
                d="M14 9.5a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm-6 5.7c0 .8.8.8.8.8h6.4s.8 0 .8-.8-.8-3.2-4-3.2-4 2.4-4 3.2Z" />
            <path
