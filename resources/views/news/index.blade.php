  ...
  <body class="bg-gray-100">
    <div class="container mx-auto p-4">
      <h1 class="text-2xl mb-4">
        <a href="{{ route('news.index') }}" class="text-black hover:text-blue-500">
        ニュース要約</a>
      </h1>
      <form action="{{ route('news.index') }}" method="GET">
        <input type="text" name="keyword" class="border border-gray-300 p-2 rounded w-64" placeholder="キーワードを入力" value="{{ request('keyword', '') }}">
