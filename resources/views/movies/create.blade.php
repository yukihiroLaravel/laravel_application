    ...
    <form action="{{ route('movie.store') }}" method="post">
        ...
        <div class="form-group mt-5">
            <div class="form-group">
                ...
                <p>
                    例）登録したいYouTube動画のURLが?<span>https://www.youtube.com/watch?v=-bNMq1Nxn5o?なら</span><br>
                    "v="の直後にある?"<span class="text-success">-bNMq1Nxn5o</span>"?を入力
                </p>
                <input type="text" name="youtube_id" id="youtube_id" class="form-control" value="{{ old('youtube_id') }}">
            </div>
            <div class="form-group">
