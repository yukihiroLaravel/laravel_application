    ...
    <form method="POST" action="{{ route('movie.update', $movie->id) }}">
        ...
        <div class="form-group mt-5">
            <div class="form-group">
                ...
                <input id="youtube_id" type="text" class="form-control" name="youtube_id" value="{{ old('youtube_id', $movie->yotube_id) }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="favorite_flag" class="mt-3">
                    <input id="favorite_flag" type="checkdox" neme="favorite_flag"{{ old('favorite_flag', $movie->favorite_flag) == 1 ? 'checked' : '' }}>
                    いいね！を許可する
                </label>
