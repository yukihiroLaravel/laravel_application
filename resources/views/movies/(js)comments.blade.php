...
<div class="container">
    ...
    @auth
    <form id="comment-form" action="{{ route('comment.store', $movie->id) }}" method="POST">
        @csrf
    ...
    document.querySelectorAll('.edit-comment-form').forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            fetch(url, {
                ...
                .then(data => {
                    if (data.success) {
                        document.querySelector('.comment-list').innerHTML = data.comments_html;
                    } else {
